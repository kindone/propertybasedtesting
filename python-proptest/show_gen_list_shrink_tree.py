#!/usr/bin/env python3
"""
Script to extract and display the shrink tree from Gen.list(Gen.int(), 0, 4)
where the generated list has size 4.
"""
...
def main():
    print("=" * 80)
    print("SHRINK TREE FROM Gen.list(Gen.int(), 0, 4)")
    print("=" * 80)
    
    # Create the generator
    gen = Gen.list(Gen.int(), min_length=0, max_length=4)
    ...
    print("\n" + "=" * 80)
    print("SHRINK TREE STRUCTURE")
    print("=" * 80)
    
    # Build and print the tree
    tree = build_tree_structure(shrinkable, max_depth=8)
    ...
    print("\nTree structure (showing up to 8 levels deep):")
    print("-" * 80)
    print_tree(tree, max_depth=8)
    
    # Print flat sorted list
    print("\n" + "=" * 80)
    print_flat_sorted(shrinkable, max_depth=8)
